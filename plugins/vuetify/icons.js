...
import academicCap from '@images/icons/academic-cap.svg'
import arrowDownTray from '@images/icons/arrow-down-tray.svg'
import archiveBox from '@images/icons/archive-box.svg'
import customClose from '@images/icons/close.svg'

const customIcons = {
  'mdi-checkbox-blank-outline': checkboxUnchecked,
  'mdi-checkbox-indeterminate': checkboxIndeterminate,
